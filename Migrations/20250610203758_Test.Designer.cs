...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrigadeMember", b =>
                {
                    b.Property<int>("BrigadesId")
                        .HasColumnType("integer");

                    b.Property<int>("MembersId")
                        .HasColumnType("integer");

                    b.HasKey("BrigadesId", "MembersId");
            ...
            modelBuilder.Entity("BrigadeMember", b =>
                {
                    b.HasOne("ConstructionOrganizations.Models.Brigade", null)
                        .WithMany()
                        .HasForeignKey("BrigadesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConstructionOrganizations.Models.Employee", null)
                        .WithMany()
